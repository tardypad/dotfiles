...
FZF_DEFAULT_OPTS="${FZF_DEFAULT_OPTS},ctrl-{key/interrupt/low}:abort,ctrl-{key/quit/low}:abort,{key/esc}:abort"
FZF_DEFAULT_OPTS="${FZF_DEFAULT_OPTS},{key/enter/enter}:accept"
...
FZF_DEFAULT_OPTS="${FZF_DEFAULT_OPTS},{key/btab}:up,{key/up/up}:up"
FZF_DEFAULT_OPTS="${FZF_DEFAULT_OPTS},{key/tab}:down,{key/down/down}:down"
