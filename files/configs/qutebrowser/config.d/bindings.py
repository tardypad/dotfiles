...
config.bind('<Ctrl-{key/command_start/upp}>',                'rl-beginning-of-line',    mode='prompt')
config.bind('<Ctrl-{key/command_end/upp}>',                  'rl-end-of-line',          mode='prompt')
config.bind('<Ctrl-{key/backspace/upp}>',                    'rl-backward-delete-char', mode='prompt')
config.bind('<Ctrl-{key/command_delete_backward_word/upp}>', 'rl-backward-kill-word',   mode='prompt')
config.bind('<Ctrl-{key/command_delete_start/upp}>',         'rl-unix-line-discard',    mode='prompt')
config.bind('<Ctrl-{key/yank/upp}>',                         'rl-yank',                 mode='prompt')
...
config.bind('{key/repeat}',                        'cmd-repeat-last',                                                          mode='normal')
config.bind('{key/open}',                          'cmd-set-text --space :open',                                               mode='normal')
...
config.bind('{key/f}{key/a}',                      'hint all current',                                                         mode='normal')
...
config.bind('<Alt-{key/left/upp}>',  'cmd-set-text --space :back',    mode='normal')
config.bind('<Alt-{key/right/upp}>', 'cmd-set-text --space :forward', mode='normal')

# search
config.bind('{key/search_forward}',        'cmd-set-text /', mode='normal')
config.bind('{key/search_backward}',       'cmd-set-text ?', mode='normal')
...
# bookmarks
config.bind('{key/bookmark/low}{key/create}',           'cmd-set-text --space :bookmark-add {url}',     mode='normal')
config.bind('{key/bookmark/low}{key/delete}',           'cmd-set-text --space :bookmark-del',           mode='normal')
config.bind('{key/bookmark/low}{key/open}',             'cmd-set-text --space :bookmark-load',          mode='normal')
config.bind('{key/bookmark/low}{key/tab}{key/open}',    'cmd-set-text --space :bookmark-load --tab',    mode='normal')
config.bind('{key/bookmark/low}{key/window}{key/open}', 'cmd-set-text --space :bookmark-load --window', mode='normal')

# quickmarks
config.bind('{key/bookmark/upp}{key/create}',           'cmd-set-text --space :quickmark-add {url}',     mode='normal')
config.bind('{key/bookmark/upp}{key/delete}',           'cmd-set-text --space :quickmark-del',           mode='normal')
config.bind('{key/bookmark/upp}{key/open}',             'cmd-set-text --space :quickmark-load',          mode='normal')
config.bind('{key/bookmark/upp}{key/tab}{key/open}',    'cmd-set-text --space :quickmark-load --tab',    mode='normal')
config.bind('{key/bookmark/upp}{key/window}{key/open}', 'cmd-set-text --space :quickmark-load --window', mode='normal')

# tabs management
config.bind('{key/tab}{key/create}',          'open --tab about:blank ;; cmd-set-text --space :open', mode='normal')
config.bind('{key/tab}{key/close}',           'tab-close',                                            mode='normal')
config.bind('{key/tab}{key/bookmark/low}',    'cmd-set-text --space :bookmark-load --tab',            mode='normal')
config.bind('{key/tab}{key/bookmark/upp}',    'cmd-set-text --space :quickmark-load --tab',           mode='normal')
...
config.bind('{key/tab}<Alt-{key/left/upp}>',  'cmd-set-text --space :back --tab',                     mode='normal')
config.bind('{key/tab}<Alt-{key/right/upp}>', 'cmd-set-text --space :forward --tab',                  mode='normal')
...
config.bind('{key/tab}{key/f}{key/a}',        'hint all tab-fg',                                      mode='normal')
...
config.bind('{key/window}{key/bookmark/low}',    'cmd-set-text --space :bookmark-load --window',  mode='normal')
config.bind('{key/window}{key/bookmark/upp}',    'cmd-set-text --space :quickmark-load --window', mode='normal')
...
config.bind('{key/window}<Alt-{key/left/upp}>',  'cmd-set-text --space :back --window',           mode='normal')
...
config.bind('{key/window}{key/f}{key/a}',        'hint all window',                               mode='normal')
config.bind('{key/window}{key/f}{key/l}',        'hint links window',                             mode='normal')
config.bind('{key/window}{key/undo}',            'undo --window',                                 mode='normal')


# sessions management
config.bind('{key/session}{key/save}',   'cmd-set-text --space :session-save',   mode='normal')
config.bind('{key/session}{key/delete}', 'cmd-set-text --space :session-delete', mode='normal')
config.bind('{key/session}{key/open}',   'cmd-set-text --space :session-load',   mode='normal')
