...
bind -T move 4 switch-client -T move \; run "tmux-move-window-index 4"
bind -T move 5 switch-client -T move \; run "tmux-move-window-index 5"
bind -T move 6 switch-client -T move \; run "tmux-move-window-index 6"
bind -T move 7 switch-client -T move \; run "tmux-move-window-index 7"
bind -T move 8 switch-client -T move \; run "tmux-move-window-index 8"
bind -T move 9 switch-client -T move \; run "tmux-move-window-index 9"
bind -T move 0 switch-client -T move \; run "tmux-move-window-index 10"
...
bind -T root M-j run "tmux-select-pane-vim j"
bind -T root M-k run "tmux-select-pane-vim k"
bind -T root M-l run "tmux-select-pane-vim l"
...
bind -T MOVE 4 switch-client -T MOVE \; run "tmux-move-pane-window-index 4"
bind -T MOVE 5 switch-client -T MOVE \; run "tmux-move-pane-window-index 5"
bind -T MOVE 6 switch-client -T MOVE \; run "tmux-move-pane-window-index 6"
bind -T MOVE 7 switch-client -T MOVE \; run "tmux-move-pane-window-index 7"
bind -T MOVE 8 switch-client -T MOVE \; run "tmux-move-pane-window-index 8"
bind -T MOVE 9 switch-client -T MOVE \; run "tmux-move-pane-window-index 9"
bind -T MOVE 0 switch-client -T MOVE \; run "tmux-move-pane-window-index 10"
