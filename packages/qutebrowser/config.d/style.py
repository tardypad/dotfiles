...
c.colors.downloads.start.bg                     = colors['base08']
c.colors.downloads.start.fg                     = colors['base06']
c.colors.downloads.stop.bg                      = colors['base08']
...
c.hints.border                                  = "1px solid " + colors['base0A']
...
c.colors.statusbar.progress.bg                  = colors['base08']

c.colors.statusbar.url.error.fg                 = colors['error']
c.colors.statusbar.url.fg                       = colors['base06']
c.colors.statusbar.url.hover.fg                 = colors['base07']
c.colors.statusbar.url.success.http.fg          = colors['base06']
c.colors.statusbar.url.success.https.fg         = colors['base0E']
...
c.colors.tabs.indicator.start                   = colors['base08']
c.colors.tabs.indicator.stop                    = colors['base08']
c.colors.tabs.indicator.system                  = "none"
c.colors.tabs.odd.bg                            = colors['background']
c.colors.tabs.odd.fg                            = colors['foreground']
c.colors.tabs.selected.even.bg                  = colors['base08']
c.colors.tabs.selected.even.fg                  = colors['base00']
c.colors.tabs.selected.odd.bg                   = colors['base08']
