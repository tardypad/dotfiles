...
config.bind('t1', 'tab-focus --no-last 1', mode='normal')
config.bind('t2', 'tab-focus --no-last 2', mode='normal')
config.bind('t3', 'tab-focus --no-last 3', mode='normal')
config.bind('t4', 'tab-focus --no-last 4', mode='normal')
config.bind('t5', 'tab-focus --no-last 5', mode='normal')
config.bind('t6', 'tab-focus --no-last 6', mode='normal')
config.bind('t7', 'tab-focus --no-last 7', mode='normal')
config.bind('t8', 'tab-focus --no-last 8', mode='normal')
config.bind('t9', 'tab-focus --no-last 9', mode='normal')
config.bind('t0', 'tab-focus --no-last 10', mode='normal')
