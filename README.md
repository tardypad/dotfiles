...
| git                    | version control                      | [Github](https://github.com/git/git)                                   | [2.17.1](https://github.com/git/git/releases/tag/v2.17.1)                                                                             |
| gnupg                  | OpenPGP client                       | [GnuPG](https://git.gnupg.org/cgi-bin/gitweb.cgi?p=gnupg.git)          | [2.2.7](https://git.gnupg.org/cgi-bin/gitweb.cgi?p=gnupg.git;a=tag;h=gnupg-2.2.7)                                                     |
| gnuplot                | graphing utility                     | [SourceForge](https://sourceforge.net/p/gnuplot/gnuplot-main/)         | [5.2.3](https://sourceforge.net/p/gnuplot/gnuplot-main/ci/5.2.3/tree/)                                                                |
...
| libqalculate           | calculator                           | [Github](https://github.com/Qalculate/libqalculate)                    | [2.5.0](https://github.com/Qalculate/libqalculate/releases/tag/v2.5.0)                                                                |
...
| neomutt                | mail client                          | [Github](https://github.com/neomutt/neomutt)                           | [20180512](https://github.com/neomutt/neomutt/releases/tag/neomutt-20180512)                                                          |
| newsboat               | RSS reader                           | [Github](https://github.com/newsboat/newsboat)                         | [2.11.1](https://github.com/newsboat/newsboat/releases/tag/r2.11.1)                                                                   |
...
| pacman                 | packages manager                     | [Arch Linux](https://git.archlinux.org/pacman.git)                     | [5.1.0](https://git.archlinux.org/pacman.git/tag/?h=v5.1.0)                                                                           |
| qutebrowser            | web browser                          | [Github](https://github.com/qutebrowser/qutebrowser)                   | [1.3.1](https://github.com/qutebrowser/qutebrowser/releases/tag/v1.3.1)                                                               |
...
| networkmanager         | network manager                      | [freedesktop.org](https://cgit.freedesktop.org/NetworkManager/NetworkManager)          | [1.10.8](https://cgit.freedesktop.org/NetworkManager/NetworkManager/tag/?h=1.10.8)                                     |
